...
**User Personas** (infer from the product if not explicit):
```
Persona: <Name>
Role: <who they are>
Primary goal: <what they're trying to achieve with this product>
Technical level: Beginner / Intermediate / Expert
Key frustrations: <what typically annoys users like this>
```

Define 2-3 personas. If the product only has one clear user type, define one deeply.
